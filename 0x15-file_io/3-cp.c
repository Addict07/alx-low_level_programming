 ...
 *
 * Return: Pointer to the created space of  buffer.
 */
char *create_buffer(char *file)
{
	char *buffer;
...
/**
 * close_file - This file close file descriptors.
 * @fd: file descriptor.
 */
void close_file(int fd)
{
...
/**
 * main - This copies one file to another file.
 ...
 *              If the file_from cannot be read - exit code 98.
